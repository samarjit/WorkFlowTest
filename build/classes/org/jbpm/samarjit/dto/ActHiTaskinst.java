...
public class ActHiTaskinst  implements java.io.Serializable {
    ...
    public ActHiTaskinst(String id, String procDefId, String taskDefKey, String procInstId, String executionId, String name, String parentTaskId, String description, String owner, String assignee, Date startTime, Date endTime, Long duration, String deleteReason, Integer priority, Date dueDate) {
       this.id = id;
    ...
    @Column(name="START_TIME_", nullable=false, length=23)
    ...
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name="END_TIME_", length=23)
